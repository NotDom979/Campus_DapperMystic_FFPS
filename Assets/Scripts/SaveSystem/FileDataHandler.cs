...
public class FileDataHandler
{
    ...
    public void Save(GameData data)
    {
        /*
                ...
                PlayerPrefs.SetInt("Armor", data.armor);
        ...
        try
        {
            ...
            using (FileStream stream = new FileStream(fullP + "/"+ dataFileName, FileMode.Create))
            {
    ...
    public GameData Load()
    {
        ...
        /*
                 ...
                 if (PlayerPrefs.HasKey("Armor"))
                     loadData.armor = PlayerPrefs.GetInt("Armor");
                 if (PlayerPrefs.HasKey("Health"))
                     loadData.health = PlayerPrefs.GetInt("Health");
